 ...
 * 
 */
package me.bunny._b._core.menu.service.impl;
...
import me.bunny._b._core.menu.model.SysMenu;
import me.bunny._b._core.menu.service.MenuService;
import me.bunny._b._core.menu.vo.MenuTreeTemplate;
import me.bunny._b._core.menu.vo.SysMenuOutVO;
import me.bunny._b._core.tree.JTreeNode;
import me.bunny._b._core.tree.JTreeNodeMenu;
import me.bunny._b._core.tree.JTreeUtils;
...
public class MenuServiceImpl extends ServiceSupport implements MenuService {
	...
	public List<JTreeNode> getMenuTreeByUser(String userId) {
		...
		return JTreeUtils.buildTree("-1", data, JTreeNodeMenu.class);
	}
